				...
				>
					...
					>
						...
						<p class="mb-8 text-gray-700 text-center">
							...
							<span class="font-semibold">{parseFloat(cashEffettivi().replace(',', '.')).toLocaleString("it-IT", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} €</span> come da te richiesto.
						</p>
